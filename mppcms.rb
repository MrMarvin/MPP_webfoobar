...
class Mppcms
  ...
  def initialize
    @pages = {
      "Heim" => {:subpages => ["Über dieses Projekt","Technische Realisierung"], :color => "#218ec6"},
      "Ruby" => {:subpages => ["Installation","Die Sprache","Von Schienen und Bühnen"], :color => "#B41010"},
      "JavaScript" => {:subpages => ["Frameworks","JQuery","AJAX","andere Gemeinheiten"], :color => "#17A83A"}
      }
  end
